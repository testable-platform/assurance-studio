...
"""Stub: All-Defs Coverage % — All Definition Coverage (not the target metric for this branch)."""
TOOL_HINT = 'Beniget'
DOMAIN = 'All Definition Coverage'

class AllDefsCoverageAnalyzer(object):
...
def evaluate_all_defs_coverage_sample(inputs):
    """Lightweight domain helper for All-Defs Coverage %."""
    analyzer = AllDefsCoverageAnalyzer('all_defs_coverage')
